        ...
        <div class="col-12 my-5">
            <div class="wcfm-container simple variable external grouped booking">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <p>
                                    ...
                                    <a class="ml-2 btn btn-success" href="<?=base_url()?>pedidos/exportarPedidosNew">Exportar Pedidos Nuevos</a>
                                    <?php if ($_SESSION['usuarios_id']==9) { ?>
                                    <?php } ?>
                                </p>
                            </div>
                            <?php
                ...
                <div class="cajetin-pedidos">
                    ...
                    <div class="col-12 listado card d-none" id="pedidos_antiguos">
