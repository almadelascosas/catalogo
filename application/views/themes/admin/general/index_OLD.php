    ...
    <div class="col-12">
        ...
        <div class="col-12 my-5">
          <div class="wcfm-container simple variable external grouped booking">
              ...
              <form action="<?=base_url()?>general/guardarMetodos" method="post" class="col-12 mt-5">
                <div class="col-12 ">
                  <ul>
                    <?php
                    foreach ($metodos_pagos->result_array() as $key => $value) { ?>
                    <li class="card my-2 p-2 d-inline-block col-md-4 col-12">
                        <label class="w-100 my-4">
                          ...
                          <input <?php if ($value['alma_metodos_pagos_estatus']==1) {
                            echo "checked";
                          } ?> class="check_online" name="estatus[]" onchange="cambioEstatus(this);" type="checkbox" value="1">
                          <span></span>
                          <input type="hidden" name="alma_metodos_pagos_estatus[]"  value="<?php 
                          if ($value['alma_metodos_pagos_estatus']==1) { 
                            echo "1"; 
                            }else{ echo "0"; } ?>">
                        </label>
                        <p><?=$value['alma_metodos_pagos_titulo']?></p>
                    </li>
                    <?php
                    }
                    ?>
        ...
        <div class="col-12 my-5">
          <div class="wcfm-container simple variable external grouped booking">
              ...
              <form action="<?=base_url()?>general/guardarWhatsapp" method="post" class="col-12 mt-5">
        ...
        <div class="col-12 my-5">
          <div class="wcfm-container simple variable external grouped booking">
              ...
              <form action="<?=base_url()?>general/guardarMenu" method="post" class="col-12 mt-5">
                <div class="row">
                  ...
                  <div class="col-md-4 col-12 form-group">
                    <label class="w-100">
                      ...
                      <select class="form-control" name="menu_categoria_agg" id="menu_categoria_agg">
                        <?php
                        foreach ($categorias_menu->result_array() as $key => $value) { ?>
                          ...
                          foreach ($menu['menu']->result_array() as $key => $value) {
                            ...
                            <div id="item-<?=$value['menu_id']?>" class="rounded border">
                              ...
                              <div class="col-11 offset-1 p-2 mt-2 rounded border">
                                <a target="_blank" href="<?=$value2['menu_enlace']?>"><?=$value2['menu_texto']?></a>
                                <span style="float: right;cursor:pointer;height: 100%;width: 20px;text-align: center;" onclick="$(this).parent().remove();leerPadres();">x</span>
        ...
        <div class="col-12 my-5">
          <div class="wcfm-container simple variable external grouped booking">
              ...
              <form action="<?=base_url()?>general/guardarBannerHome" method="post" class="col-12 mt-5">
                <div class="row">
                  <div class="col-md-8 col-12 form-group">
                    <label class="w-100">
                      ...
                      <div class="col-12 card-gallery border rounded mb-2 text-center">
                          <?php
                          if ($banner_home['banner_imagen']!=NULL && $banner_home['banner_imagen']!="" && $banner_home['banner_imagen']!=0) {
                              ?>
                          <img class="principal " onclick="galeria(this);" src="<?=base_url().$banner_home['banner_imagen_url']?>" alt="Placeholder">
                              <?php
                          }else{ ?>
                    ...
                    <label class="w-100">
                      ...
                      <div class="col-12 card-gallery border rounded mb-2 text-center">
                          <?php
                          if ($banner_home['banner_imagen_mobile']!=NULL && $banner_home['banner_imagen_mobile']!="" && $banner_home['banner_imagen_mobile']!=0) {
                              ?>
                          <img class="principal " onclick="galeriaMini(this);" src="<?=base_url().$banner_home['banner_imagen_mobile_url']?>" alt="Placeholder">
                              <?php
                          }else{ ?>
        ...
        <div class="col-12 my-5">
          <div class="wcfm-container simple variable external grouped booking">
              ...
              <form action="<?=base_url()?>general/guardarBannerCorporativos" method="post" class="col-12 mt-5">
                <div class="row">
                  <div class="col-12 form-group">
                    <label class="w-100">
                      ...
                      <div class="col-12 card-gallery border rounded mb-2 text-center">
                        <?php
                        if ($banner_corporativos['banner_imagen']!=NULL && $banner_corporativos['banner_imagen']!="" && $banner_corporativos['banner_imagen']!=0) {
                            ?>
                        <div class="col-12" onclick="galeriaBanner(this);">
                          <img class="principal" src="<?=base_url().$banner_corporativos['banner_imagen_url']?>" alt="Placeholder">
                          <input type="hidden" required id="" name="banner_imagen" value="<?=$banner_corporativos['banner_imagen']?>">
                        </div>
                            <?php
                        }else{ ?>
                        <div class="col-12" onclick="galeriaBanner(this);">
                          <img class="principal" src="<?=base_url()?>assets/uploads/Placeholder.png" alt="Placeholder">
                          <input type="hidden" required id="" name="banner_imagen" value="">
                        </div>
                        <?php
                        }
                        ?>
                    ...
                    <label class="w-100">
                      ...
                      <div class="col-12 card-gallery border rounded mb-2 text-center">
                        <?php
                        if ($banner_corporativos['banner_imagen_mobile']!=NULL && $banner_corporativos['banner_imagen_mobile']!="" && $banner_corporativos['banner_imagen_mobile']!=0) {
                            ?>
                        <div class="col-12" onclick="galeriaBanner(this);">
                          <img class="principal" src="<?=base_url().$banner_corporativos['banner_imagen_mobile_url']?>" alt="Placeholder">
                        ...
                        <div class="col-12" onclick="galeriaBanner(this);">
                          <img class="principal" src="<?=base_url()?>assets/uploads/Placeholder.png" alt="Placeholder">
                          <input type="hidden" required id="" name="banner_imagen_mobile" value="">
                        </div>
                        <?php
                        }
                        ?>
        ...
        <div class="col-12 my-5">
          <div class="wcfm-container simple variable external grouped booking">
            ...
            <form action="<?=base_url()?>general/guardarBannerApp" method="post" class="col-12 mt-5">
                    ...
                    <label class="w-100">
                      ...
                      <select class="form-control" name="banner_app_id_redireccion[]">
                        ...
                        if ($value['banner_app_tipo']==0 || $value['banner_app_tipo']==2) {
                          ...
                          <option <?php if($value2['categorias_id']==$value['banner_app_id_redireccion']){ echo "selected"; } ?> value="<?=$value2['categorias_id']?>"><?=$value2['categorias_nombre']?></option>
                          <?php
                          }
                        }else{
                          foreach ($productos->result_array() as $key2 => $value2) { ?>
                          <option <?php if($value2['productos_id']==$value['banner_app_id_redireccion']){ echo "selected"; } ?> value="<?=$value2['productos_id']?>"><?=$value2['productos_titulo']?></option>
                          <?php
                          }
                        }
                        ?>
        ...
        <div class="col-12 my-5">
          <div class="wcfm-container simple variable external grouped booking">
            ...
            <form action="<?=base_url()?>general/guardarBannerMensajes" method="post" class="col-12 mt-5">
              <div class="row">
                <?php
