...
<div class="content">
    <div class="col-12">
        ...
        <form enctype="multipart/form-data" id="form-pedido" class="col-12 my-5 contact-form" action="<?=base_url()?>pedidos/guardar_new" method="post">
                ...
                <div class="col-12">
                    <div class="row">
                        ...
                        <div class="col-12 card">
                            ...
                            <div class="card-body">
                                <table class="table table-alma" style="overflow:scroll;">
                                    <thead>
                                        <tr>
                                            <th></th>
                                            <th>Artículo</th>
                                            ...
                                            if ($value2['pedidos_detalle_producto_cantidad'] > 0) {
                                                foreach ($pedido['productos']->result_array() as $key => $value) {
                                                    ...
                                                    <tr class="<?php if ($_SESSION['tipo_accesos']!=0 && $_SESSION['tipo_accesos']!=1 && $value['productos_vendedor']!=$_SESSION['usuarios_id']) { echo "d-none"; } ?>">
                                                        ...
                                                        <td>
                                                            <a href="<?=base_url()?>/productos/editar/<?=$value['productos_id']?>/<?=limpiarUri($value['productos_titulo'])?>"><?=$value['productos_titulo']?></a><br>
                                                            <span>
                                                                (<?=$value['productos_sku']?>)
                                                            </span>
                                                            <p class="addons">
                                                                        ...
                                                                        if (isset($value15[$i15]->addons_respuesta)) {
                                                                            for ($resp=0; $resp < count($value15[$i15]->addons_respuesta); $resp++) {
                                                                                ...
                                                                                if (isset($value15[$i15]->addons_valor[$resp])) {
                                                                                    if ($value15[$i15]->addons_valor[$resp] > 0) {
                                                        ...
                                                        <td>
                                                            ...
                                                            if ($pedido['pedido']['pedidos_estatus']==1 
                                                            || $pedido['pedido']['pedidos_estatus']=="Esperando confirmación de pago" 
                                                            || $pedido['pedido']['pedidos_estatus']=="Esperando confirmación de Pago" 
                                                            || $pedido['pedido']['pedidos_estatus']==4 
                                                            ...
                                                            <select name="pedidos_productos_estatus[]"  class="<?php if ($pedido['pedido']['pedidos_estatus']!=4 && $pedido['pedido']['pedidos_estatus']!="En preparación" && $pedido['pedido']['pedidos_estatus']!="Enviado" && $pedido['pedido']['pedidos_estatus']!="Reembolsado") { echo "d-none"; } ?> pedidos_productos_estatus form-control" onchange="popEmpresa(this);">
                                                                <?php
                                                                if ($_SESSION['tipo_accesos']==0 || $_SESSION['tipo_accesos']==1) { ?>
                                                            ...
                                                            <input type="hidden" name="pedidos_productos_estatus[]" value="">
                                                            <input type="hidden" name="nro_guia[]" value="">
                                                            <input type="hidden" name="nombre_empresa[]" value="">
                                                                <?php
                                                            }
                                                            ?>
                                                        </td>
                                                        <td>$ <?=number_format($value2['pedidos_detalle_producto_precio'], 0, ',', '.')?></td>
                                                        <td>
                                                            <?php
                                                            $this_price = 0;
