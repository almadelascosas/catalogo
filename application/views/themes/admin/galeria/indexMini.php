...
<div class="tab-content" id="myTabContent">
        ...
        <div clas="col-12">
            <div class="row" id="galeria-result">
                ...
                <div class="col-md-3 col-sm-4 col-6 image-gallery">
                    <label for="image-<?=$value['medios_id']?>" onclick="selectImageMini(<?=$value['medios_id']?>,'<?=$value['medios_url']?>')">
            ...
            <div class="col-12 text-center">
                <div class="paginado">
                    <ul class="list-inline">
                        <li>
                            <!-- ?page=1 -->
                            <a onclick="paginadoGaleria('prev');" class="d-none" id="prev-gallery" href="javascript:void(0)" >Anterior</a>
                        </li>
                        <li>
                            <span id="paginaGaleria" class="btn rounded border mx-2">1</span>
                        </li>
                        <li>
                            <a onclick="paginadoGaleria('next');" id="next-gallery" href="javascript:void(0)">Siguiente</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div class="tab-pane fade" id="subirimg" role="tabpanel" aria-labelledby="subirimg-tab">
        ...
        <input type="file" onchange="uploadImageMini('#medios-galeria')" name="medios_attachment" id="medios-galeria" data-default-file="" data-max-file-size="2M" class="dropify">
