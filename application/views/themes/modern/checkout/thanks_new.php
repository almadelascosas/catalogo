...
<main class="col-12 cuerpo float-left mb-5">
    <div class="row background-pago">
        ...
        <div class="col-12 text-center">
            <img src="<?=$parametroEstado['icono']?>" style="max-width: 160px;">  
        </div>
        <div class="col-12 text-center normal">
            <h5 class="text-center mt-2"><b><?=$parametroEstado['titulo']?></b></h5>
        </div>
        <div class="col-2"></div>
        <div class="col-8 text-center normal">
            <?=$parametroEstado['descrip']?>
        </div>        
        <div class="col-12" style="height:30px">&nbsp;</div>
        
        <?php if($parametroEstado['estado']==='exitoso'){ ?>
        ...
        <?php }else if($parametroEstado['estado']==='error' || $parametroEstado['estado']==='rechazado' || $parametroEstado['estado']==='cancelado'){ ?>
