            ...
            <div class="row">
                ...
                if ($pedido['pedido']['pedidos_metodo_pago']=="pse" || $pedido['pedido']['pedidos_metodo_pago']==4) { 
                    ...
                    $vads = array(
                        ...
                        "vads_url_success" => base_url('checkout/pago-retorno/exitoso/pedido-'.$pedido['pedido']['pedidos_id']),
                        "vads_url_error" => base_url('checkout/pago-retorno/error/pedido-'.$pedido['pedido']['pedidos_id']),
                        "vads_url_refused" => base_url('checkout/pago-retorno/rechazado/pedido-'.$pedido['pedido']['pedidos_id']),
                        "vads_url_cancel" => base_url('checkout/pago-retorno/cancelado/pedido-'.$pedido['pedido']['pedidos_id']),
                        "vads_version" => "V2"
                    );
                    ...
                    <form action="https://secure.payzen.lat/vads-payment/" method="post" class="col-lg-8 offset-lg-2 col-md-6 card-metodo-pago form-checkout offset-md-3 col-12 mt-5">
                        ...
                        <input type="hidden" name="vads_url_success" value="<?=base_url('checkout/pago-retorno/exitoso/pedido-'.$pedido['pedido']['pedidos_id'])?>" />
                        <input type="hidden" name="vads_url_error" value="<?=base_url('checkout/pago-retorno/error/pedido-'.$pedido['pedido']['pedidos_id'])?>" />
                        <input type="hidden" name="vads_url_refused" value="<?=base_url('checkout/pago-retorno/rechazado/pedido-'.$pedido['pedido']['pedidos_id'])?>" />
                        <input type="hidden" name="vads_url_cancel" value="<?=base_url('checkout/pago-retorno/cancelado/pedido-'.$pedido['pedido']['pedidos_id'])?>" />
