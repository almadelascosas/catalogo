<?php
if(isset($producto['productos_id']) && $producto['productos_id']!=NULL && $producto['productos_id']!="" && $producto['productos_id']!=0){ ?>
<script>
    idActual = <?=$producto['productos_id']?>;
</script>
<div class="section fp-section fp-table active fp-completely section-reel">
                    ...
                    <div class="col-5 h-100 d-table bg-light px-0">
                        <div class="col-12 h-100 normal-scroll scroll-y scroll-pers">
                            <div class="row">
                                ...
                                <div class="col-12 bottom-desc-reel"></div>
                            </div>
                        </div>
